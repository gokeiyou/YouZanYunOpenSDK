...
{
    public class SalesmanItemShareGetRequest : YouZanRequest
    {
        /// <summary>
        /// 商品别名
        /// item_id或item_alias选其一，另者置为0，都填以item_alias为准
        /// </summary>
        [ApiField("item_alias")]
        ...
        /// <summary>
        /// 手机号
        /// mobile或fans_id选其一，另者置为0，当fans_id和mobile都传时，优先按mobile查询
        /// </summary>
        [ApiField("mobile")]
